...
export const adjust_octaves = writable(
  localStorage.getItem(adjust_octaves_key) === "true"
);
adjust_octaves.subscribe((value) =>
  localStorage.setItem(adjust_octaves_key, String(value))
);
