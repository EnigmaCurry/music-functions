...
>
  <Dropzone
    ...
    accept="audio/midi"
    name="midi"
    >Drag and drop a single MIDI file here or click to select a file.</Dropzone
  >
  ...
  <br />
  <label for="tonics"
    >Keyboard position to mirror (eg. C4 for the middle): <br /><small
      >(you can enter multiple notes to flip each one consecutively; separate by
      space)</small
    ></label
  ><br />
